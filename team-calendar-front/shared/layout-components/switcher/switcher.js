          ...
          <div className="ti-offcanvas-body" id="switcher-body">
            <div id="switcher-1" role="tabpanel" aria-labelledby="switcher-item-1" className="">
              ...
              <div className="">
                ...
                <div className="grid grid-cols-3 switcher-style">
                  <div className="flex">
                    <input type="radio" name="page-loader" className="ti-form-radio" checked={local_varaiable.loader == "enable"} id="switcher-loader-enable" onChange={e => { }} onClick={() => switcherdata.Enable(ThemeChanger)} />
                  ...
                  <div className="flex">
                    <input type="radio" name="page-loader" className="ti-form-radio" id="switcher-loader-disable" onChange={e => { }} checked={local_varaiable.loader == "disable"} onClick={() => switcherdata.Disable(ThemeChanger)} />
