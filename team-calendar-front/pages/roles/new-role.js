...
import { createRole } from "@/shared/services/roleApis";
...
const NewRole = () => {
  ...
  return (
    <Fragment>
      <Seo title={"Add a new role"} />
      <Pageheader
        currentpage="Add a new role"
        activepage="Roles"
            ...
            <form onSubmit={newRole}>
              <div className="box-body add-products !p-0">
                ...
                <div className="px-6 py-4 border-t border-dashed dark:border-defaultborder/10 sm:flex justify-end">
                  ...
                  >
                    Add Role<i className="bi bi-plus-lg ms-2"></i>
                  </button>
                </div>
              </div>
            </form>
