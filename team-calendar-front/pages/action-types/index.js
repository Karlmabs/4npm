...
const Index = () => {
  ...
  const handleDelete = (idToRemove) => {
    deleteActionType(idToRemove).then(
      (response) => {
  ...
  return (
    <Fragment>
      <Seo title={"Action Types List"} />
      <Pageheader
        currentpage="Action Types List"
        activepage="Action Types"
        mainpage="Action types List"
      />
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-12 col-span-12">
          <div className="box">
            <div className="box-header">
              <div className="box-title">Action Types List</div>
            </div>
